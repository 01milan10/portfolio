<template>
  <div>
    <div
      class="absolute inset-0 lg:max-w-3xl lg:my-5 lg:mx-auto lg:rounded-lg lg:shadow-lg overflow-hidden overflow-y-scroll"
    >
      <div class="sticky top-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 896 240"
          class="hidden w-full text-blue-900 lg:block"
        >
          <polygon points="0,0 896,0 896,180 0,240" fill="currentColor" />
        </svg>
        <div
          class="lg:absolute lg:top-0 lg:right-0 lg:left-0 bg-blue-900 lg:bg-opacity-75 md:px-12 md:py-8 lg:mx-0 px-4 py-5 lg:p-7"
        >
          <div
            class="flex items-center justify-between max-w-2xl mx-auto lg:mx-0 lg:max-w-full text-white"
          >
            <div class>
